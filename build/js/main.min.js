...
var header = document.querySelector(".header__nav-list");
...
var getSwiper = function getSwiper() {
  if (!swiperContainer) {
    ...
    swiper.on("slideChange", function () {
      var firstIframe = document.querySelector(".banner__video-player");
      var secondIframe = document.querySelector(".banner__video-iframe");
      var secondIframeParent = document.querySelector(".banner__video-img");
      ...
      if (secondIframe === null) {
        ...
        secondIframe.setAttribute("src", "https://music.yandex.ru/iframe/#track/112912322/25474374");
      ...
      firstIframe.src = "".concat(firstIframe.src, "?").concat(hours, ":").concat(minutes, ":").concat(seconds);
