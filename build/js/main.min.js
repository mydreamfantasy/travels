...
window.addEventListener("DOMContentLoaded", function () {
  ...
  // ---------------------------------
  (0, _swiper.getSwiper)();
  (0, _swiper.getSwiperTours)();
  (0, _swiper.getSwiperLearn)();
  (0, _swiper.getSwiperReviews)();
  (0, _swiper.getSwiperFeatures)();
  (0, _swiper.getSwiperGallery)();
...
},{"./modules/form-validate/form":3,"./modules/open-menu":9,"./modules/swiper":10,"./modules/video":11,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";
...
var navToggle = document.querySelector(".header__nav__toggle");
...
exports.getSwiperTours = exports.getSwiperReviews = exports.getSwiperLearn = exports.getSwiperGallery = exports.getSwiperFeatures = exports.getSwiper = void 0;
...
var getSwiper = function getSwiper() {
  if (!swiperContainer) {
    ...
    var swiper = new _swiper.default(".banner", {
      loop: true,
      pagination: {
    ...
    swiper.on("slideChange", function () {
      ...
      var videoIframes = document.querySelectorAll(".banner__video-player");
      var audioContainer = document.querySelectorAll("#audio");
      var audioIframes = document.querySelectorAll(".banner__video-iframe");
      videoContainer.forEach(function (el) {
        var newVideoEl = document.createElement("div");
      ...
      videoIframes.length && videoIframes.forEach(function (el) {
        return el.remove();
      });
      audioContainer.forEach(function (el) {
        var newAudioEl = document.createElement("iframe");
        newAudioEl.setAttribute("class", "banner__video-iframe");
        newAudioEl.setAttribute("src", "https://music.yandex.ru/iframe/#track/112912322/25474374");
        newAudioEl.width = "340";
        newAudioEl.height = "220";
        newAudioEl.setAttribute("tabindex", "-1");
        el.append(newAudioEl);
      });
      audioIframes.length && audioIframes.forEach(function (el) {
        return el.remove();
      });
    });
...
var getSwiperTours = function getSwiperTours() {
  if (!swiperContainer) {
    return;
  } else {
    var swiper = new _swiper.default('[data-swiper="tours"]', {
...
exports.getSwiperTours = getSwiperTours;
var getSwiperLearn = function getSwiperLearn() {
  if (!swiperContainer) {
    return;
  } else {
    var swiper = new _swiper.default('[data-swiper="learning"]', {
      direction: "horizontal",
      watchOverflow: true,
      loop: false,
      navigation: {
...
exports.getSwiperLearn = getSwiperLearn;
...
var getSwiperFeatures = function getSwiperFeatures() {
  if (!swiperContainer) {
    return;
  } else {
    var swiper = new _swiper.default('[data-swiper="features"]', {
      breakpoints: {
        1200: {
          slidesPerView: "auto",
          spaceBetween: 30,
...
exports.getSwiperFeatures = getSwiperFeatures;
var getSwiperGallery = function getSwiperGallery() {
  if (!swiperContainer) {
    return;
  } else {
    var swiper = new _swiper.default('[data-swiper="gallery"]', {
      slidesPerView: "auto",
      spaceBetween: 5,
      navigation: {
...
exports.getSwiperGallery = getSwiperGallery;
...
},{"../../media/video":15}],12:[function(require,module,exports){
"use strict";
